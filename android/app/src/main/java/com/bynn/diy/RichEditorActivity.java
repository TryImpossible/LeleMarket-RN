...
//        mPreview = (TextView) findViewById(R.id.preview);
        mEditor.setOnTextChangeListener(new RichEditor.OnTextChangeListener() {
            @Override public void onTextChange(String text) {
                RichEditorActivity.this.html = text;
//                mPreview.setText(text);
        ...
        findViewById(R.id.action_insert_image).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
//                mEditor.insertImage("https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=1485834719,2425074308&fm=27&gp=0.jpg",
//                        "dachshund");
                mEditor.insertImage("http://file.yirimao.com/1488878219-771243-0.jpg", "alt");
            }
        });
