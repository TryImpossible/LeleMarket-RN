...
import org.wordpress.editor.EditorFragment;
import org.wordpress.editor.EditorFragmentAbstract;

/**
 * Created by yedidyak on 24/07/2016.
 */
public class WordpressEditorManager extends ReactContextBaseJavaModule implements EditorFragmentAbstract.EditorFragmentListener {

    private static EditorFragment editorFragment;
    private static String originalTitle = "";
    private static String originalBody = "";

    private static WordpressEditorManager instance;

    public static WordpressEditorManager getInstance() {
        return instance;
    }

    public WordpressEditorManager(ReactApplicationContext reactContext) {
        super(reactContext);
        instance = this;
    }
